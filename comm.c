...
//function definition for sendDATA, this function will calculate 16000 sample for 8 pieces of faster decibel values
//and send them using curl library function to url, the format of post data is
